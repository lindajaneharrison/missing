# Web Figure 6 (Sample Size Calculation for Randomized Clinical Trials via Inverse Probability of Response Weighting 
...
fig_n <- ggplot() + 
  ...
  scale_y_continuous(breaks=c(1000,2000,4000,6000,8000),lim=c(1000,8000)) +
